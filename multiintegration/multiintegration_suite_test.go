...
const (
	...
	existingBucketInDefaultRegion    = "cf-redis-service-backup-integration-test-restricted"
	existingBucketInNonDefaultRegion = "cf-redis-service-backup-integration-test"
	region                           = "us-west-2"
)
